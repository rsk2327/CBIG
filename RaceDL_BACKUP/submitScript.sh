...
#####$ -o /cbica/home/gastouna/sge_job_output/python.$JOB_ID.stdout
#### save the standard error:
#$ -e /cbica/home/santhosr/sge_job_output/python.$JOB_ID.stderr
####
#### My email address:
##$ -M 
...
Send deep learning pipeline.
 qsub -j y -o  /gpfs/cbica/home/santhosr /gpfs/cbica/home/santhosr/RaceDL_BACKUP/Modeling/PyTorch//submitTest2.sh
HELP
}
...
python /gpfs/fs001/cbica/home/santhosr/RaceDL_BACKUP/Modeling/PyTorch/train.py

# # Path to main python file
# if [ -z "$1" ]
# then
#      echo "Setting default python file to run file "
#     python /gpfs/fs001/cbica/home/santhosr/RaceDL_BACKUP/Modeling/PyTorch/train.py 
# 	#python /gpfs/cbica/home/gastouna/Scripts/testForRoshan/Roshanstest.py 
# else
